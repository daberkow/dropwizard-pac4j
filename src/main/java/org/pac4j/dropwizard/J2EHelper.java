...
public final class J2EHelper {
    ...
    private static void registerFilter(Environment environment, Config config,
        ...
        final FilterHelper filterHelper = new FilterHelper(environment.getApplicationContext().getServletContext());
        filterHelper.addFilterMapping(filter.getClass().getName(), filter, mapping);

//        final FilterRegistration.Dynamic filterRegistration = environment
//                .servlets().addFilter(filter.getClass().getName());
//
